...
```javascript
isComplex = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-complex@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-complex@umd/bundle.js"></script>
```
